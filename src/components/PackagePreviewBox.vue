<template>
  <div class="preview-box" @click="editPackage">
    <img class="preview-image" src="~@/assets/login.jpg">
    <span class="overlay" v-show="pkg.price">Price ${{ formatPrice (pkg.price) }}</span>
    <div
      class="preview-title"
    >{{ pkg.property.address || "New Valuation" }}, {{ pkg.property.city }}</div>
